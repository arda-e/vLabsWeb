    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 md:w-1/2 w-full">
        <div className="h-full bg-gray-100 p-8 rounded">
          ...
          <p className="leading-relaxed mb-6">Pademi süreci ile birlikte fiziksel cihaz üzerindeki mobil testlerin uzaktan yapılabilmesi ihtiyacı bir anda arttı. Kısa zamanda Visium Farm’ın Akbank içerisinde konumlandırdık ve ekiplerin kullanımına açtık.</p>
          <a className="inline-flex items-center">
            ...
            <span className="flex-grow flex flex-col pl-4">
              <span className="title-font font-medium text-gray-900">İsmail İntikam</span>
              <span className="text-gray-500 text-sm">BT Proje Yönetimi Bölümü, Product Owner <br/> Akbank</span>
            </span>
          </a>
        </div>
      </div>
