...
const ProductHeroSection = ({heading, subheading, backgroundSrc, textPosition}) => {
    ...
    return (
    textPosition === "center" ?
    <section className=" flex bg-gradient-to-r from-red-600 to-yellow-600 flex-col items-start bg-gray-300 mx-auto justify-center h-60 px-8 md:px-32">
    <div className="max-w-7xl flex px-8 sm:px-8 md:px-10 lg:px:24 xl:px-32 self-center flex-col">
            ...
            <section className=" flex bg-gradient-to-r from-red-600 to-yellow-600 flex-col items-start bg-gray-300 mx-auto justify-center h-60">
            <div className=" max-w-7xl flex px-8 sm:px-8 md:px-10 lg:px:24 xl:px-32 self-center flex-col">
